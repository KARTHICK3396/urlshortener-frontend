  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <Link to="/" className="text-2xl font-extrabold text-blue-400 tracking-tight">URL Shortener</Link>
        <div>
          {token ? (
            <>
              <Link to="/dashboard" className="text-gray-300 hover:text-blue-400 mx-4 font-medium transition-colors">Dashboard</Link>
              <Link to="/urls" className="text-gray-300 hover:text-blue-400 mx-4 font-medium transition-colors">My URLs</Link>
            ...
            <>
              <Link to="/login" className="text-gray-300 hover:text-blue-400 mx-4 font-medium transition-colors">Login</Link>
