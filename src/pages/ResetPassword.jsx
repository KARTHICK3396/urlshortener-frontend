...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setError('');
    try {
      const res = await axios.post(`https://urlshortener-backend-mruz.onrender.com/api/auth/reset-password/${token}`, { newPassword });
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4 relative">
          ...
          <div className="relative">
            <input className="w-full px-3 py-2 border rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10" type={showPassword ? "text" : "password"} value={newPassword} onChange={(e) => setNewPassword(e.target.value)} required />
