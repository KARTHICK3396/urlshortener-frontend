        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6 relative">
            ...
            <div className="relative">
              <input className="w-full px-3 py-2 border rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10" id="password" type={showPassword ? "text" : "password"} onChange={handleChange} required />
